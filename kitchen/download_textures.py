"""
Download PBR textures from ambientCG (CC0 license) for kitchen floor and walls.
...
Usage:
    ...
    python kitchen/download_textures.py --output kitchen/textures
"""
...
# ---- Texture definitions (kitchen appropriate) ----
TEXTURES = {
    "floor": [
        {"id": "Tiles074",      "category": "tile",    "tiles_per_meter": 2.0},
        {"id": "Tiles101",      "category": "tile",    "tiles_per_meter": 2.0},
        {"id": "Tiles086",      "category": "tile",    "tiles_per_meter": 2.0},
        {"id": "Tiles093",      "category": "tile",    "tiles_per_meter": 2.0},
...
def main():
    parser = argparse.ArgumentParser(description="Download PBR textures from ambientCG (kitchen)")
    parser.add_argument("--output", type=str,
                        default=str(Path(__file__).resolve().parent / "textures"),
                        help="Output directory for textures (default: kitchen/textures)")
