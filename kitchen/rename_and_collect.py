...
CANDIDATES_CSV = os.path.join(BASE_DIR, "objaverse_kitchen", "kitchen_candidates.csv")
PATHS_CSV = os.path.join(BASE_DIR, "objaverse_kitchen", "kitchen_downloaded_paths.csv")

OUTPUT_DIR = os.path.join(BASE_DIR, "kitchen_assets_raw")
