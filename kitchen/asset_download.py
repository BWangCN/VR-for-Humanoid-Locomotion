...
"""
Download kitchen assets from Objaverse (Sketchfab, ~800K objects).
...
Run:
  python kitchen/asset_download.py --out_dir ./kitchen/objaverse_kitchen --per_class 20 --processes 16
"""
...
# --- Keyword sets for kitchen furniture ---
BIG_ASSETS = {
    "dining_table": ["dining table", "kitchen table"],
    "fridge":       ["fridge", "refrigerator"],
    "cabinet":      ["kitchen cabinet", "cupboard", "pantry"],
    "oven":         ["oven", "stove", "range cooker"],
    "dishwasher":   ["dishwasher"],
}

SMALL_ASSETS = {
    "chair":         ["dining chair", "kitchen chair"],
    "stool":         ["stool", "bar stool", "kitchen stool"],
    "trash_can":     ["trash can", "trash bin", "garbage can", "waste bin", "dustbin"],
    "pot":           ["pot", "cooking pot", "saucepan"],
    "pan":           ["pan", "frying pan", "skillet"],
    "bottle":        ["bottle"],
    "mug":           ["mug", "coffee mug", "cup"],
    "plate":         ["plate", "dinner plate", "dish"],
    "bowl":          ["bowl", "mixing bowl", "salad bowl"],
    "cutting_board": ["cutting board", "chopping board"],
    "towel":         ["towel", "kitchen towel", "dish towel"],
    "shoes":         ["shoes"],
    "box":           ["box"],
    "bag":           ["bag", "grocery bag", "shopping bag"],
}
...
NEGATIVE_PATTERNS = {
    ...
    "pot":    [r"teapot", r"flower\s*pot", r"potted"],
    "pan":    [r"japan", r"panama", r"panel", r"panoram"],
    "plate":  [r"template", r"license plate", r"nameplate", r"faceplate"],
    "bowl":   [r"bowling", r"super bowl"],
    "bag":    [r"airbag", r"beanbag", r"sandbag"],
}
...
def main():
    ap = argparse.ArgumentParser(description="Download kitchen assets from Objaverse")
    ap.add_argument("--out_dir", type=str, default="./kitchen/objaverse_kitchen",
    ...
    print("Filtering by kitchen keywords...")
    ...
    csv_path = os.path.join(args.out_dir, "kitchen_candidates.csv")
    ...
    paths_csv = os.path.join(args.out_dir, "kitchen_downloaded_paths.csv")
    ...
    summary_path = os.path.join(args.out_dir, "kitchen_summary.csv")
