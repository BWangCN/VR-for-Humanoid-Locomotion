...
CANDIDATES_CSV = os.path.join(BASE_DIR, "objaverse_livingroom", "livingroom_candidates.csv")
PATHS_CSV = os.path.join(BASE_DIR, "objaverse_livingroom", "livingroom_downloaded_paths.csv")

OUTPUT_DIR = os.path.join(BASE_DIR, "livingroom_assets_raw")
